  ...
  : [
      ...
      },
      {
        ...
        value: [
          ...
          "font-src 'self'",
          "connect-src 'self' https://nominatim.openstreetmap.org https://router.project-osrm.org https://www.google.com https://basemaps.cartocdn.com https://*.basemaps.cartocdn.com https://api.openai.com https://recaptchaenterprise.googleapis.com https://vercel.live",
          'frame-src https://www.google.com https://recaptcha.google.com https://vercel.live',
          "object-src 'none'",
          "base-uri 'self'",
          "form-action 'self'",
        ].join('; '),
