  ...
  : [
      ...
      },
      {
        ...
        value: [
          ...
          "font-src 'self'",
          "connect-src 'self' https://nominatim.openstreetmap.org https://router.project-osrm.org https://www.google.com https://basemaps.cartocdn.com https://*.basemaps.cartocdn.com https://api.openai.com",
